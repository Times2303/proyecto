            ...
            <div id="step-1" class="step grid grid-cols-[47%_47%] gap-4">
                <div>
                    <div class="mb-6">
                        ...
                        <input value="{{ old('nom_parroquia', $parroquia->nom_parroquia) }}" type="text" id="nom_parroquia" name="nom_parroquia" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="dir_parroquia" class="block mb-2 text-sm font-medium text-gray-900">Dirección</label>
                        <input value="{{ old('dir_parroquia', $parroquia->dir_parroquia) }}" type="text" id="dir_parroquia" name="dir_parroquia" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                    </div>
                </div>
                <div>
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ old('lugar', $parroquia->lugar) }}" type="text" id="lugar" name="lugar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2">
                    </div>
                    <div class="mb-6">
                        <label for="telefono" class="block mb-2 text-sm font-medium text-gray-900">Telefono</label>
                        <input value="{{ old('telefono', $parroquia->telefono) }}" type="text" id="telefono" name="telefono" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2">
                    </div>
                </div>
            </div>
            <!-- Navigation Buttons -->
