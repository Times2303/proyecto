...
<div class="fixed inset-0 backdrop-blur-sm flex items-center justify-center z-50">
    ...
    <div class="bg-white rounded-lg shadow-lg p-2 md:p-4 w-xl">
        <a href="{{ route('sacerdotes.index') }}" class="text-times-morado hover:text-times-hmorado mb-4"><i class="fa-solid fa-arrow-left"></i> Volver</a>
            ...
            <div id="step-1" class="step grid grid-cols-[47%_47%] gap-4">
                ...
                <div>
                    <div class="mb-6">
                        ...
                        <input value="{{ $sacerdote->fec_inicio }}" type="date" id="fec_inicio" name="fec_inicio" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hmorado w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="fec_fin" class="block mb-2 text-sm font-medium text-gray-900">Fecha de retiro</label>
                        <input value="{{ $sacerdote->fec_fin }}" type="date" id="fec_fin" name="fec_fin" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hmorado w-full p-2">
                    </div>
