        ...
        <form action="{{ route('personas.update', $persona->id) }}" id="multi-step-form" method="POST">
            ...
            <div id="step-1" class="step grid grid-cols-[30%_67%] gap-4">
                <div class="">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="num_identificacion" name="num_identificacion" value="{{ $persona->num_identificacion }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2" required>
                    </div>
                    <div class="mb-6">
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ $persona->fecha_nacimiento }}" type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                    </div>
                </div>
                <div class="space-y-4">
                    <div class="mb-6">
                        <label for="nombres" class="block mb-2 text-sm font-medium text-gray-900">Nombres</label>
                        <input value="{{ $persona->nombres }}" type="text" id="nombres" name="nombres" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="apellido1" class="block mb-2 text-sm font-medium text-gray-900">Apellido paterno</label>
                        <input value="{{ $persona->apellido1 }}" type="text" id="apellido1" name="apellido1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="apellido2" class="block mb-2 text-sm font-medium text-gray-900">Apellido materno</label>
                        <input value="{{ $persona->apellido2 }}" type="text" id="apellido2" name="apellido2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2">
                    </div>
                </div>
            </div>
            ...
            <div id="step-2" class="step hidden">
                <div class="mb-6">
                    ...
                    <input value="{{ $persona->email }}" type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                </div>
                <div class="mb-6">
                    <label for="direccion" class="block mb-2 text-sm font-medium text-gray-900">Dirección de su hogar</label>
                    <input value="{{ $persona->direccion }}" type="text" id="direccion" name="direccion" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                </div>
                <div class="mb-6">
                    <label for="celular" class="block mb-2 text-sm font-medium text-gray-900">Celular</label>
                    <input value="{{ $persona->celular }}" type="text" id="celular" name="celular" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-green-500 focus:border-green-500 block w-full p-2" required>
                </div>
            </div>
