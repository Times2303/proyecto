        ...
        <form action="{{ route('personas.store') }}" id="multi-step-form" method="POST">
            ...
            <div id="step-1" class="step grid grid-cols-[30%_67%] gap-4">
                <div>
                    ...
                    <select class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" id="tipo_identificacion" name="tipo_identificacion" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="num_identificacion" name="num_identificacion" value="{{ old('num_identificacion') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="nacionalidad" class="block mb-2 text-sm font-medium text-gray-900">Nacionalidad</label>
                        <select id="nacionalidad" name="nacionalidad" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                    ...
                    <div class="mb-6">
                        ...
                        <input value="{{ old('fecha_nacimiento') }}" type="date" id="fecha_nacimiento" name="fecha_nacimiento" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                    </div>
                </div>
                <div>
                    <div class="mb-6">
                        <label for="nombres" class="block mb-2 text-sm font-medium text-gray-900">Nombres</label>
                        <input value="{{ old('nombres') }}" type="text" id="nombres" name="nombres" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="apellido1" class="block mb-2 text-sm font-medium text-gray-900">Apellido paterno</label>
                        <input value="{{ old('apellido1') }}" type="text" id="apellido1" name="apellido1" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                    </div>
                    <div class="mb-6">
                        <label for="apellido2" class="block mb-2 text-sm font-medium text-gray-900">Apellido materno</label>
                        <input value="{{ old('apellido2') }}" type="text" id="apellido2" name="apellido2" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2">
                    </div>
                </div>
            </div>
            ...
            <div id="step-2" class="step hidden">
                <div class="mb-6">
                    ...
                    <input value="{{ old('email') }}" type="email" id="email" name="email" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                </div>
                <div class="mb-6">
                    <label for="direccion" class="block mb-2 text-sm font-medium text-gray-900">Dirección de su hogar</label>
                    <input value="{{ old('direccion') }}" type="text" id="direccion" name="direccion" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                </div>
                <div class="mb-6">
                    <label for="celular" class="block mb-2 text-sm font-medium text-gray-900">Celular</label>
                    <input value="{{ old('celular') }}" type="text" id="celular" name="celular" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:outline-none focus:border-times-hazul w-full p-2" required>
                </div>
            </div>
